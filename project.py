...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        w6=tk.Button(self,text='Exit',font=15,height=4,width=8,relief='raised')
        w6.place(x=700,y=650)
        w6.bind('<Button-1>',quit)
...
class WithdrawPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        heading_label = tk.Label(self,text='ATM',font=('orbitron',45,'bold'),foreground='#ffffff',background='#3d3d5c')
        heading_label.pack(pady=25)
        ...
        one_hundred_button = tk.Button(button_frame,text='100',command=lambda:withdraw(100),relief='raised',borderwidth=3,width=50,height=5)
        ...
        back=tk.Button(button_frame,text='Back',command=menu)
...
class DepositPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        back=tk.Button(self,text='Back',command=menu)
        back.place(x=700,y=500)
...
class BalancePage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        exit_button = tk.Button(button_frame,
                                                 text='Exit',command=exit,relief='raised',borderwidth=3,width=50,height=5)
